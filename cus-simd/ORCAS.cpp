...
void ORCASketch<number_of_options_ind>::initialize(int sketch_size, int number_of_arrays, int number_of_array_counters, int seed)
{
    ...
    {
        int temp[array_size];
        _mm256_storeu_si256((__m256i*) temp, array_counter_inv_lookup_table[i]);
        for (int j = 0; j < array_size; j++)
        {
            cout << temp[j] << " ";
        }
...
void ORCASketch<number_of_options_ind>::increment(const char * str)
{
    ...
    __m256i inv_counter_vec = array_counter_inv_lookup_table[option_index];
    ...
    cout << "min_inc_vec: ";
    int temp_min_inc_vec[array_size];
    ...
    cout << "\ninv_counter_vec: ";
    int temp_counter_vec[array_size];
    ...
    cout << "\nmin_cou_vec: ";
    int temp_min_inc_counter_vec[array_size];
...
void ORCASketch<number_of_options_ind>::create_lookup_tables(bool n_array_counter_is_pow_2)
{
    ...
    array_counter_inv_lookup_table = new __m256i[number_of_options];
    ...
    for (int i = 0; i < number_of_options; i++)
    {
        ...
        array_counter_inv_lookup_table[i] = _mm256_set_epi32(inv_temp[7], inv_temp[6], inv_temp[5], inv_temp[4],
